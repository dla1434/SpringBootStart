...
import com.spring.boot.config.PersistableCronTriggerFactoryBean;
...
class JobUtil {
	 ...
	 */
	protected static JobDetail createJob(Class<? extends QuartzJobBean> jobClass, boolean isDurable, ApplicationContext context, String jobName,
			String jobGroup) {
